...
// std::unique_ptr<WindowContext> MakeGLForOhos(OHNativeWindow*, std::unique_ptr<const DisplayParams>, uint32_t, uint32_t);
...
std::unique_ptr<WindowContext> MakeGraphiteDawnVulkanForOhos(OHNativeWindow*, std::unique_ptr<const DisplayParams>, uint32_t, uint32_t);
